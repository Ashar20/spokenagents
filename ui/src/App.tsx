    ...
    >
      ...
      <div style={{ padding: "16px 24px 8px" }}>
        ...
        <p style={{ margin: "4px 0 0", fontSize: 13, color: "#475569" }}>
          Say "order food from Bella" — Alex will run the negotiation and you'll hear
          machine beats while it talks to Bella's agent.
        </p>
      </div>
      ...
      <div style={{ padding: "24px", color: "#334155", fontSize: 12 }}>
        Audio events: connect browser with sound on to hear the handshake sweep,
        negotiation chirps, and settlement chime.
      </div>
    </div>
  );
}
